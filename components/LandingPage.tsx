  ...
  return (
    <div className="relative" id="home">
      ...
      >
        ...
        <div className="relative pt-30 p-8 ml-auto lg:pt-36">
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
              Create your own chat <span className="text-primary dark:text-white">privacy</span>
            </h1>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
              ...
              >
                <span className="relative text-base font-semibold text-white dark:text-black">Get started</span>
              </a>
              <a
                href="/pricing"
